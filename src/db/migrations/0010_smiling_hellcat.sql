/*
You're trying to delete PRIMARY KEY(nomination_id,user_id) from 'votes' table
...
/*
You're trying to add PRIMARY KEY(category_id,user_id) to 'votes' table
...
*/
--> statement-breakpoint
ALTER TABLE votes ADD `category_id` integer NOT NULL;